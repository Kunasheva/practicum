...
while True: # начинаем бесконечный цикл приема клиентов
	conn, addr = sock.accept() # принимаем соединение от клиента
	print(f'connected {addr}') # выводим присоединившегося клиента на экран
